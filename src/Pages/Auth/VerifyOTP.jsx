        ...
        >
          {otp.map((digit, index) => (
            <input
              ...
              className="w-11 h-11 sm:w-12 sm:h-12 md:w-14 md:h-14 text-center text-base sm:text-lg px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#9D4C1D] focus:border-[#9D4C1D]"
              required
            />
          ))}
        </div>
